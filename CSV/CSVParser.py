...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\36\7\5\2\2\36\7\3\2\2\2\37#\7\7\2\2 #\7\6\2\2!#\3\2\2")
...
class CSVParser ( Parser ):
    ...
    class NoneContext(FieldContext):
    ...
    def field(self):
        ...
        try:
            ...
            if token in [CSVParser.STRING]:
                ...
                localctx = CSVParser.NoneContext(self, localctx)
